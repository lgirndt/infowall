...
(function (window, $, undefined) {
    ...
    ChartView.prototype.onRender = function(html) {
        $elem = $(html);
        ...
        var dataSet = [
            {"legendLabel":"Firefox", "magnitude":2},
            {"legendLabel":"Two", "magnitude":3},
            {"legendLabel":"Three", "magnitude":2},
...
//
        ...
        .text(function(d) {
            var val = dataSet[d];
            return val.legendLabel + " " + val.magnitude + "%";
        });
    };
